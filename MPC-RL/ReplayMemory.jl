...
function append!(memory::ReplayMemory{S,A,R}, s::AbstractVector{S}, a::AbstractVector{A}, r::R, d::Bool) where {S<:Real, A<:Real, R<:Real}
...
function sample(memory::ReplayMemory{S,A,R}) where {S<:Real, A<:Real, R<:Real}
